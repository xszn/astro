...
<Notice type="note">视频教程请移步 YouTube 观看《[Real-ESRGAN 使用教程](https://youtu.be/TYLZB24PZyw)》。</Notice>
...
下载完成后，将压缩包解压到指定文件夹，如“Real-ESRGAN”。如果需要处理视频，建议安装 FFmpeg，这样可以方便地提取和合成视频帧，提升视频处理效果和效率。操作简单，方便使用。
...
<Notice type="note">更多模型请移步《[Real-ESRGAN 模型库](https://github.com/xinntao/Real-ESRGAN/blob/master/docs/model_zoo.md)》。</Notice>
...
1. [Real-ESRGAN GitHub][1]
2. [Real-ESRGAN 动漫视频模型介绍 - GitHub][2]
3. [Real-ESRGAN ncnn Vulkan GitHub][3]

[1]: https://github.com/xinntao/Real-ESRGAN/blob/master/README_CN.md
[2]: https://github.com/xinntao/Real-ESRGAN/blob/master/docs/anime_video_model.md
